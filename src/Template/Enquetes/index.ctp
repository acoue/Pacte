				...
				<div class="row">
					...
					<div class="col-md-10">
						...
						//Affichage du nombre d'enquete
							...
							else if ($nbEnquete == 1) echo "<p>Sur la campagne n°".$campagne.", votre équipe a réalisé une enquête.</p>";
							else echo "<p>Sur la campagne n°".$campagne.", votre équipe a répondu à ".$nbEnquete." enquêtes.</p>";
